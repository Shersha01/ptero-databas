...
echo ""
echo "Exectuting Panel Restoration Script..."
echo ""

/bin/sleep 2


bash <(curl -s https://raw.githubusercontent.com/NotRoyadma/ptero_database_repo_main/main/everything_in_one/restore_ptero_panel_nginx_mysql.sh)
...
echo ""
echo "starting wing's Restoration script"

/bin/sleep 2

bash <(curl -s https://raw.githubusercontent.com/NotRoyadma/ptero_database_repo_main/main/everything_in_one/restore_ptero_wings_nginx_mysql_serverfiles.sh)
